...
import '../screens/notes_list_screen.dart'; // for showAddNoteSheet
import 'journal_editor.dart'; // for showAddJournalSheet

import '../../state/study_layout_provider.dart'; // for CardSize

class YourSpaceHero extends ConsumerStatefulWidget {
  final CardSize size;
  const YourSpaceHero({super.key, required this.size});

  @override
  ConsumerState<YourSpaceHero> createState() => _YourSpaceHeroState();
}

class _YourSpaceHeroState extends ConsumerState<YourSpaceHero> {
    ...
    return Column(
      children: [
        Padding(
          ...
          child: Text(
            "Verses you've marked in colour — the ones that spoke to you.",
    ...
    return Column(
      children: [
        Padding(
          padding: const EdgeInsets.fromLTRB(20, 20, 20, 10),
          child: Text(
            "Verses set aside to study more — passages to return to and understand deeper.",
            style: theme.textTheme.bodySmall?.copyWith(
              color: theme.colorScheme.onSurface.withValues(alpha: 0.7),
              height: 1.4,
            ),
