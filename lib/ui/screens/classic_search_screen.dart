...
class ClassicSearchScreen extends ConsumerStatefulWidget {
  const ClassicSearchScreen({super.key});

  @override
  ConsumerState<ClassicSearchScreen> createState() => _ClassicSearchScreenState();
}

class _ClassicSearchScreenState extends ConsumerState<ClassicSearchScreen> with SingleTickerProviderStateMixin {
                            ...
                            child: Row(
                              ...
                              children: [
                                _buildFilterChip(
                                  ...
                                  isActive: (searchState.filterOt || searchState.filterNt),
                                  onTap: () {
