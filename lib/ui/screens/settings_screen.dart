          ...
          children: [
            _buildSection(context, 'General', [
              Consumer(builder: (context, ref, _) {
                final defaultStartTab = ref.watch(
                    readSettingsProvider.select((s) => s.defaultStartTab));
            ...
            _buildSection(context, 'Reading', [
              Consumer(builder: (context, ref, _) {
                ...
                final allTranslations =
                    ref.watch(availableTranslationsProvider);
              ...
              Consumer(builder: (context, ref, _) {
                final showNumbers = ref.watch(
                    readSettingsProvider.select((s) => s.showVerseNumbers));
                return SwitchListTile(
              ...
              Consumer(builder: (context, ref, _) {
                final keepAwake = ref.watch(
                    readSettingsProvider.select((s) => s.keepScreenAwake));
                return SwitchListTile(
              ...
              Consumer(builder: (context, ref, _) {
                final primaryIndex = ref.watch(readSettingsProvider
                    .select((s) => s.primaryHighlightColorIndex));
                final secondaryIndex = ref.watch(readSettingsProvider
                    .select((s) => s.secondaryHighlightColorIndex));

                Widget buildColorPicker(String title, String subtitle,
            ...
            _buildSection(context, 'Advanced', [
              ...
              Consumer(builder: (context, ref, _) {
                final swipeDown = ref.watch(
                    bibleNavSettingsProvider.select((s) => s.swipeDownToNav));
                return SwitchListTile(
                  title: Text(
                ...
                return Column(
                  children: [
                    ListTile(
                      ...
                      subtitle:
                          const Text('Export notes, highlights, and settings'),
                    ...
                    ListTile(
                      ...
                      subtitle:
                          const Text('Import your data from a backup JSON'),
                      onTap: () {
                                ...
                                onPressed: () async {
                                  ...
                                  await ref
                                      ...
                                      .setBackgroundGlowStyle(
                                          BackgroundGlowStyle.top);
                                  await ref
                                      .read(readSettingsProvider.notifier)
                                      .setVerseActionStyle(
                                          VerseActionStyle.classic);
                                  await ref
                                      .read(readSettingsProvider.notifier)
            ...
            const SizedBox(
                height: 100), // Bottom padding to clear nav bar and FAB
          ],
        ),
      ),
    );
